...
export type InternalState = { transcribe_running: boolean; active_transcription_run_id: string | null; audio_step_size: number; version: string; name: string; runtime_dependency: RuntimeDependencyState }
